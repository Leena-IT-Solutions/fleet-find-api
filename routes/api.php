...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/children/{id}/tracking', [AuthController::class, 'getChildTracking']);
    ...
    Route::get('/organization/{orgId}/trips/{tripId}/routes/{routeId}/tracking', [\App\Http\Controllers\Api\TripLogisticsController::class, 'getRouteTracking']);
});
