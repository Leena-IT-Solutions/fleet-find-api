                        ...
                        <div class="w-full rounded-xl bg-[#111625] border border-slate-800 shadow-xl flex flex-col overflow-hidden text-white text-[8px]">
                            ...
                            <div class="bg-[#151D30] p-4 text-left min-h-[180px] flex flex-col justify-between">
                                ...
                                <div class="space-y-1 mt-2">
                                    <div class="flex justify-between bg-[#1C273E] p-2 rounded"><span>🚌 Bus #04 (Sector 12 Route)</span><span class="text-emerald-400 font-bold">ONLINE</span></div>
                                    <div class="flex justify-between bg-[#1C273E] p-2 rounded"><span>🚌 Bus #11 (Central Station Route)</span><span class="text-emerald-400 font-bold">ONLINE</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
