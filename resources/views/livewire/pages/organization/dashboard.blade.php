                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    @if (auth()->user()->hasRole('Admin'))
                        <div class="flex-shrink-0">
                            <a href="{{ route('dashboard') }}" class="inline-flex items-center gap-2 px-4 py-2 border border-indigo-200 rounded-lg text-sm font-medium text-indigo-700 bg-indigo-50/50 hover:bg-indigo-50 hover:text-indigo-800 transition shadow-sm">
